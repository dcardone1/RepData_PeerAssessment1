...
### Import data manipulation library (Install the package if needed with install.package("dplyr))
...
## ℹ Summaries were computed grouped by interval and weekday.
## ℹ Output is grouped by interval.
## ℹ Use `summarise(.groups = "drop_last")` to silence this message.
## ℹ Use `summarise(.by = c(interval, weekday))` for per-operation grouping
